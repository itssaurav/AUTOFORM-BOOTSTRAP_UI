...
DropZone.propTypes = {
	...
	children: _react.PropTypes.node, // Contents of the dropzone
	style: _react.PropTypes.object, // CSS styles to apply
	activeStyle: _react.PropTypes.object, // CSS styles to apply when drop will be accepted
	rejectStyle: _react.PropTypes.object, // CSS styles to apply when drop will be rejected
	className: _react.PropTypes.string, // Optional className
	activeClassName: _react.PropTypes.string, // className for accepted state
	rejectClassName: _react.PropTypes.string, // className for rejected state

	disablePreview: _react.PropTypes.bool, // Enable/disable preview generation
	disableClick: _react.PropTypes.bool, // Disallow clicking on the dropzone container to open file dialog

	inputProps: _react.PropTypes.object, // Pass additional attributes to the <input type="file"/> tag
	multiple: _react.PropTypes.bool, // Allow dropping multiple files
	accept: _react.PropTypes.string, // Allow specific types of files. See https://github.com/okonet/attr-accept for more information
	name: _react.PropTypes.string // name attribute for the input tag
};
